...
if ($ApkFile) {
    ...
    Write-Host "  2. Tap APK file to install"
    Write-Host "  3. Grant permissions when prompted"
    Write-Host "  4. Launch 'P2P Paylaş' from app drawer"
    Write-Host "`nApp Name: P2P Paylaş"
    Write-Host "Package: org.p2p.p2pshare"
